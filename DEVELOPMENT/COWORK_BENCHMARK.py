...
class CoworkBenchmark:
    def __init__(self):
        # Target either active browser game or fallback to Program Manager (desktop)
    ...
    def run_all(self):
        ...
        # 1. Mouse Speed & Curve Test
        self.test_mouse_movement()
        
        # 2. Typing Speed & Delay Test
        self.test_typing()
        
        # 3. Click & Self-Healing Verification Test
    ...
    def test_mouse_movement(self):
        ...
        # Calculate total theoretical distance
        total_dist = 0
        curr = start_pos
        for tx, ty in targets:
    ...
    def test_typing(self):
        ...
        wpm = cpm / 5 # Standard WPM calculation
    ...
    def test_clicks_with_self_healing(self):
        ...
        test_actions = [
            ...
            {"name": "Click Outside Window (Static Fail Case)", "x": 10, "y": 10} # Desktop wallpaper area
        ]
        ...
        for act in test_actions:
            ...
            if success:
                ...
                print(f"⚠️ Action '{name}' failed (No visual difference). Triggering Self-Healing Loop...")
    ...
    def run_self_healing_loop(self, action_name, x, y):
        """Self-healing parameter adjustment loop"""
        calibrations = [
        ...
        for step, cal in enumerate(calibrations, 1):
            ...
            # Recapture and attempt click with adjusted parameters
            img_before = self.driver.capture()
            hash_before = self.driver.get_hash(img_before)
            
            # Draw pointer and hardware click with focus forcing
            ...
            time.sleep(2.0) # Increased wait latency for slow animations
    ...
    def save_report(self):
        ...
        with open(REPORT_PATH, "w", encoding="utf-8") as f:
            ...
            f.write(f"- **Emulation Speed**: {m.get('speed', 0):.1f} px/sec (with eases & natural delays)\n\n")
